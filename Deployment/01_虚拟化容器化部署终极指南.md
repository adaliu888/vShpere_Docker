...
- [ESXi安装脚本](#esxi安装脚本)
- [下载ESXi ISO](#下载esxi-iso)
- [创建安装脚本](#创建安装脚本)
- [ESXi安装配置](#esxi安装配置)
- [执行安装](#执行安装)
      - [3.1.2 vCenter部署](#312-vcenter部署)
- [vCenter部署配置](#vcenter部署配置)
    - [3.2 虚拟机模板](#32-虚拟机模板)
- [创建虚拟机模板](#创建虚拟机模板)
- [创建CentOS模板](#创建centos模板)
- [安装CentOS](#安装centos)
- [配置模板](#配置模板)
  - [4. 容器化部署](#4-容器化部署)
...
- [卸载旧版本](#卸载旧版本)
- [安装依赖](#安装依赖)
- [添加Docker官方GPG密钥](#添加docker官方gpg密钥)
- [添加Docker仓库](#添加docker仓库)
- [安装Docker](#安装docker)
...
- [Kubernetes集群初始化脚本](#kubernetes集群初始化脚本)
- [安装kubeadm, kubelet, kubectl](#安装kubeadm-kubelet-kubectl)
- [初始化主节点](#初始化主节点)
- [配置kubectl](#配置kubectl)
- [安装网络插件](#安装网络插件)
- [允许主节点调度Pod](#允许主节点调度pod)
      - [4.2.2 工作节点加入](#422-工作节点加入)
- [工作节点加入脚本](#工作节点加入脚本)
- [在主节点获取加入命令](#在主节点获取加入命令)
- [在工作节点执行加入命令](#在工作节点执行加入命令)
- [验证节点状态](#验证节点状态)
  - [5. 混合部署](#5-混合部署)
    - [5.1 虚拟化+容器化架构](#51-虚拟化容器化架构)
    - [5.2 部署策略](#52-部署策略)
- [混合部署脚本](#混合部署脚本)
- [创建虚拟机用于传统应用](#创建虚拟机用于传统应用)
- [部署传统应用到虚拟机](#部署传统应用到虚拟机)
- [部署微服务到Kubernetes](#部署微服务到kubernetes)
- [配置服务发现](#配置服务发现)
- [配置负载均衡](#配置负载均衡)
  - [6. 监控与运维](#6-监控与运维)
...
- [检查系统资源](#检查系统资源)
- [检查网络连接](#检查网络连接)
- [检查Docker状态](#检查docker状态)
- [检查Kubernetes状态](#检查kubernetes状态)
- [检查服务日志](#检查服务日志)
...
- [host: db.local](#host-dblocal)
- [port: 5432](#port-5432)
- [database: vcenter](#database-vcenter)
- [username: vcenter](#username-vcenter)
- [password: password123](#password-password123)
- [或使用自定义证书](#或使用自定义证书)
- [certificate: custom](#certificate-custom)
- [cert_file: /path/to/cert.pem](#cert_file-pathtocertpem)
- [key_file: /path/to/key.pem](#key_file-pathtokeypem)
    - [3.2 虚拟机模板](#32-虚拟机模板)
- [创建虚拟机模板](#创建虚拟机模板)
- [创建CentOS模板](#创建centos模板)
- [安装CentOS](#安装centos)
...
- [日志管理系统](#日志管理系统)
    - [6.3 自动化运维](#63-自动化运维)
- [自动化运维脚本](#自动化运维脚本)
- [Kubernetes服务重启](#kubernetes服务重启)
- [Docker服务重启](#docker服务重启)
- [备份数据库](#备份数据库)
- [备份配置文件](#备份配置文件)
- [备份日志](#备份日志)
  - [7. 故障排除](#7-故障排除)
...
- [运维最佳实践脚本](#运维最佳实践脚本)
- [定期维护任务](#定期维护任务)
- [清理Docker镜像](#清理docker镜像)
- [清理Kubernetes资源](#清理kubernetes资源)
- [清理日志文件](#清理日志文件)
- [更新系统包](#更新系统包)
- [重启服务](#重启服务)
- [备份脚本](#备份脚本)
