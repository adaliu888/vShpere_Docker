...
- [vRealize Automation技术详解](#vrealize-automation技术详解)
  - [vRealize Automation概述](#vrealize-automation概述)
    - [什么是vRealize Automation](#什么是vrealize-automation)
    - [核心功能](#核心功能)
  - [架构设计](#架构设计)
    - [vRA架构](#vra架构)
    - [核心组件](#核心组件)
...
- [vRA部署脚本](#vra部署脚本)
- [1. 准备部署环境](#1-准备部署环境)
- [2. 部署vRA Appliance](#2-部署vra-appliance)
- [3. 配置网络](#3-配置网络)
- [配置IP、网关、DNS](#配置ip网关dns)
- [4. 启动服务](#4-启动服务)
    - [初始配置](#初始配置)
- [vRA初始配置](#vra初始配置)
  - [蓝图设计](#蓝图设计)
