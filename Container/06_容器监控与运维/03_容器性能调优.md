...
- [Python性能分析](#python性能分析)
    - [8.3 性能基准测试](#83-性能基准测试)
      - [基准测试工具](#基准测试工具)
- [使用wrk进行HTTP基准测试](#使用wrk进行http基准测试)
- [使用ab进行Apache基准测试](#使用ab进行apache基准测试)
- [使用hey进行Go基准测试](#使用hey进行go基准测试)
      - [基准测试实现](#基准测试实现)
- [Python基准测试](#python基准测试)
  - [9. 实践案例](#9-实践案例)
...
- [获取当前性能指标](#获取当前性能指标)
- [与基准对比](#与基准对比)
- [如果性能下降，触发优化](#如果性能下降触发优化)
- [基于当前性能指标建议优化措施](#基于当前性能指标建议优化措施)
- [应用优化措施](#应用优化措施)
  - [11. 总结](#11-总结)
