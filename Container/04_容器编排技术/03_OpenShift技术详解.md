...
- [OpenShift技术详解](#openshift技术详解)
  ...
  - [3. 集群部署](#3-集群部署)
    - [3.1 安装准备](#31-安装准备)
- [安装OpenShift CLI工具](#安装openshift-cli工具)
- [安装Ansible](#安装ansible)
- [安装OpenShift Ansible](#安装openshift-ansible)
    - [3.2 集群配置](#32-集群配置)
- [inventory.ini](#inventoryini)
    - [3.3 集群部署](#33-集群部署)
- [运行Ansible playbook](#运行ansible-playbook)
- [验证部署](#验证部署)
- [配置默认路由](#配置默认路由)
- [创建默认项目](#创建默认项目)
- [配置镜像仓库](#配置镜像仓库)
