...
- [Podman架构原理深度解析](#podman架构原理深度解析)
  ...
  - [8. Podman监控与日志](#8-podman监控与日志)
    ...
    - [8.2 日志管理](#82-日志管理)
      - [8.2.1 日志类型](#821-日志类型)
      - [8.2.2 日志处理](#822-日志处理)
  - [9. Podman与Kubernetes集成](#9-podman与kubernetes集成)
...
Podman是一个开源的容器管理工具，由Red Hat开发，作为Docker的替代方案。Podman采用无守护进程架构，提供与Docker兼容的CLI接口，同时支持Pod概念和rootless容器。
