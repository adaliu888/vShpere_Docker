...
- [Kubernetes Pod管理技术详解](#kubernetes-pod管理技术详解)
  ...
  - [2. Pod创建与管理](#2-pod创建与管理)
    - [2.1 Pod创建方式](#21-pod创建方式)
      - [直接创建Pod](#直接创建pod)
- [使用kubectl创建](#使用kubectl创建)
- [使用kubectl apply](#使用kubectl-apply)
- [直接运行Pod](#直接运行pod)
      - [通过控制器创建](#通过控制器创建)
- [Deployment创建Pod](#deployment创建pod)
...
- [Pod健康检查脚本](#pod健康检查脚本)
  - [12. 快速上手指南](#12-快速上手指南)
    - [12.1 基础操作流程](#121-基础操作流程)
    - [12.2 常用场景](#122-常用场景)
      - [Web应用部署](#web应用部署)
  - [13. 命令速查表](#13-命令速查表)
    - [13.1 Pod管理命令](#131-pod管理命令)
    - [13.2 Pod调试命令](#132-pod调试命令)
    - [13.3 资源管理命令](#133-资源管理命令)
