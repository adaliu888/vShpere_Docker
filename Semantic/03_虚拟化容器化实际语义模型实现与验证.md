...
- [虚拟化容器化实际语义模型实现与验证](#虚拟化容器化实际语义模型实现与验证)
  ...
  - [6. 语义模型验证工具](#6-语义模型验证工具)
    ...
    - [6.2 验证工具使用示例](#62-验证工具使用示例)
      ...
      - [6.2.2 使用示例](#622-使用示例)
- [编译验证工具](#编译验证工具)
- [验证ESXi语义模型](#验证esxi语义模型)
- [输出示例:](#输出示例)
- [开始验证语义模型: esxi_model.sm](#开始验证语义模型-esxi_modelsm)
- [=== 语义模型验证报告 ===](#语义模型验证报告)
- [# 1. 类型检查结果:](#1-类型检查结果)
- [✓ 所有类型检查通过](#所有类型检查通过)
- [# 2. 模型检测结果:](#2-模型检测结果)
...
- [✓ 所有定理证明通过](#所有定理证明通过)
- [# 4. 总体结论:](#4-总体结论)
- [✓ 所有验证通过，语义模型正确](#所有验证通过语义模型正确)
- [# 验证报告已保存到: esxi_model_report.txt](#验证报告已保存到-esxi_model_reporttxt)
  - [7. 实际应用案例](#7-实际应用案例)
